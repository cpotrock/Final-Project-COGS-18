def end_lose_e2():
    ...
    Gives the player the second loss screen of the game.
    This is run when the player chooses the wrong option from the encounter2 function.
    ...
    while run:
        ...
        text_surface2 = normal_font.render('Your family member held on as long', True, (0, 0, 0))
        screen.blit(text_surface2, (10, 200))
        text_surface3 = normal_font.render('as they could, but it took several', True, (0, 0, 0))
        screen.blit(text_surface3, (10, 250))
        text_surface4 = normal_font.render("days to make it to the nearest town", True, (0, 0, 0))
        screen.blit(text_surface4, (10, 300))
        text_surface5 = normal_font.render('and by then, it was too late.', True, (0, 0, 0))
